...
<meta name="twitter:image" content="{{ asset('assets/promotion/images/promotion-car/og-image.jpg') }}">
    ...
    })(window,document,'script','dataLayer','GTM-5DH3T7FD');</script>
    <!-- End Google Tag Manager -->
    <script>
    gtag('event', 'conversion', {'send_to': 'AW-11332274683/VWgJCK-z-5waEPuT05sq'});
    </script>
</head>
<body>
    <div class="container">
        ...
        <div class="container-fluid adventage my-5">
            ...
            <div class="row justify-content-center align-items-stretch text-center">
                ...
                <div class="col-12 col-lg-6 pe-0">
                    ...
                    <p>
                        Bergaransi resmi 5 tahun untuk tipe Notch UV400 dan 7 tahun untuk tipe 4K Alpha Pro, Garansi ini meliputi jika kaca film tidak menempel pada kaca dan warna yang luntur. Garansi Acegard terdaftar resmi dalam situs Acegard.id
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container review-coment">
            <h1 class="text-center py-5 plus-jakarta-sans-600">Apa kata mereka?</h1>
        ...
        <div class="container-fluid slot-section d-flex justify-content-center align-items-center flex-column text-center">
            ...
            <h2 class="slot-subtitle">
                Dapatkan Penawaran Terbaik khusus hari ini!
            </h2>
            <p class="slot-desc">
                <span class="blue-text">slot terbatas</span> setiap harinya dan dapatkan <span class="blue-text">promo spesial</span> khusus bulan ini
            </p>

            <h1 id="countdown" class="slot-remaining">
                2100
            </h1>
            <p class="slot-remaining-subtitle">
                Slot Promo Spesial Tersedia
            </p>
        ...
        <div class="container-fluid my-5 button-sub-whatsapp">
            <div class="row justify-content-center align-items-center">
                <div class="col-6 col-lg-6">
                <button class="btn btn-success w-100 whatsapp-btn"><i class="bi bi-whatsapp"></i> Dapatkan Promo!</button>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid warranty">
            <div class="container text-warranty">
                <h1>
        ...
        <div class="container-fluid faq__section">
            <div class="row">
                <div class="col-12 col-lg-6 justify-content-center
                align-content-center headline__faq">
                    <h1 class="lato-black">Frequently Asked Question</h1>
                    <p class="lato-regular">Acegard sangat mementingkan kepuasan konsumen dan klien untuk menjaga integritas brand yang unggul.</p>
                </div>
            <div class="col-12 col-lg-6 justify-content-center
            ...
            <div class="accordion custom-accordion" id="faqAccordion">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            ...
                            <span class="lato-bold">Apakah kaca film Acegard membuat pandangan dari dalam mobil menjadi gelap?</span>
                            </button>
                        </h2>
                        <div id="faq1" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                            <h5 class="lato-regular">
                            Tidak. Kaca film Acegard menggunakan teknologi Night Vision, sehingga meskipun dari luar terlihat gelap, dari dalam tetap memiliki visibilitas yang baik, terutama di malam hari.
                            </h5>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            ...
                            <span class="lato-bold">Apakah saya mendapatkan garansi?</span>
                            </button>
                        </h2>
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                            <h5 class="lato-regular">
                                Garansi di berikan bersamaan dengan invoice dengan nomor garansi yang tertera dan bisa melakukan pengecekan garansi di website acegard.id.
                            </h5>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            ...
                            <span class="lato-bold">Garansi seperti apa yang dapat saya klaim?</span>
                            </button>
                        </h2>
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                            <h5 class="lato-regular">
                                Garansi dapat di klaim jika pemasangan tidak rapi, Cacat pada produk, kaca film tidak lengket ke kaca, warna memudar.
                            </h5>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            ...
                            <span class="lato-bold">Pengerjaan Berapa lama?</span>
                            </button>
                        </h2>
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                            <h5 class="lato-regular">
                                Pengerjaan Kaca Film tergantung kondisi kaca film lama, jika kaca film sudah terlalu lama maka pengerjaan akan lebih lama bisa memakan waktu 4-5 jam.
                            </h5>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function sendToWhatsApp(event) {
            ...
            let message = `Halo, saya ingin mendapatkan promo!\n\n` +
                            `Nama: ${nama}\n` +
                            `No WhatsApp: ${whatsapp}\n` +
                            `Merk & Tipe Mobil: ${mobil}\n` +
                            `Domisili: ${domisili}`;

                        let encodedMessage = encodeURIComponent(message);

                        let whatsappURL = `https://wa.me/6282121113688?text=${encodedMessage}`;

                        window.open(whatsappURL, "_blank");

            // Redirect ke WhatsApp setelah Pixel event terkirim
            setTimeout(() => {
                window.location.href = whatsappURL;
            }, 500); // Delay 0.5 detik agar Pixel sempat mengirim event
        }
    ...
    function startCountdown() {
        let count = 400; // Nilai awal countdown
        let target = 21;  // Nilai akhir countdown

        let countdownElement = document.getElementById("countdown");

        let interval = setInterval(() => {
            if (count > target) {
                count--; // Kurangi nilai countdown
                countdownElement.textContent = count;
            } else {
                clearInterval(interval); // Hentikan interval saat mencapai 21
            }
        }, 10); // Update setiap 10 milidetik (0.01 detik)
    }
